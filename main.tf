...
###############################################################################
module "aws_cw_logs" {
  source = "github.com/antonio-rufo/terraform-cloudwatch-logs-module"
...
###############################################################################
module "ecs-cluster" {
  source = "github.com/antonio-rufo/terraform-ecs-module"
...
###############################################################################
module "td" {
  source = "github.com/antonio-rufo/terraform-ecs-fargate-task-definition-module"
...
module "ecs-fargate-service" {
  source = "github.com/antonio-rufo/terraform-ecs-fargate-service-module"
  # version = "2.0.14"
